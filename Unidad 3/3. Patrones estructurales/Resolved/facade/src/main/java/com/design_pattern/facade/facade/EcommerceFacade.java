package com.design_pattern.facade.facade;

import com.design_pattern.facade.model.OrderRequest;
...
public class EcommerceFacade {
    ...
    // SOLUCIÓN: El Facade conoce los subsistemas, no el cliente
    @Autowired
    ...
    public Map<String, Object> processOrder(OrderRequest request) {
